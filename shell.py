...
os.system(
    "gcc UVash.c -o /home/runner/practica-eso/laboratorio-eso/Practica2/UVash -O3 -Wall -Werror -Wextra -pedantic -std=c99 -lreadline -lhistory -flto -floop-unroll-and-jam -floop-interchange -floop-block -floop-nest-optimize -fomit-frame-pointer -fgcse -fgcse-sm -ftree-vectorize -fivopts -fsched-pressure -maccumulate-outgoing-args"
)
